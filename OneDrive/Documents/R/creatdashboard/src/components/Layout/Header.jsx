        ...
        <div className="flex items-center justify-between">
            ...
            <div className="flex-1 max-w-md mx-8">
             ...
             <div className="flex items-center space-x-3">
              {/*Quic Action */ }  
              <button className="hidden lg:flex items-center space-x-2 py-2 px-4 bg-gradient-to-r from-blue-500 to-purple-600  text-white rounded-xl hover:shadow_lg transition-a  transition-all">
